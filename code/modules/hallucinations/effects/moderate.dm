...
/obj/effect/hallucination/delamination_alarm/Initialize(mapload, mob/living/carbon/target)
	...
	target.hear_radio(message_to_multilingual("<b>Danger! Crystal hyperstructure integrity faltering! Integrity: [rand(30, 50)]%</b>"), vname = "supermatter crystal", part_a = "<span class='[SSradio.frequency_span_class(FREQ_PUB)]'><b>\[[get_frequency_name(FREQ_PUB)]\]</b> <span class='name'>", part_b = "</span> <span class='message'>")
